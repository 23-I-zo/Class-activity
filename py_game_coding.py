...
PADDLE_WIDTH = 100 
PADDLE_HEIGHT = 20 
COUNTDOWN_TIME = 3  # Countdown timer of 3 seconds
...
class Game: 
    ...
    def draw(self, screen): 
        ...
        if self.countdown > 0:
            countdown_text = self.font.render(f"Starting in: {self.countdown}", True, WHITE)
            countdown_rect = countdown_text.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 50))
